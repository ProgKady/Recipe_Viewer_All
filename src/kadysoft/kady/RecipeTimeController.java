 ...
 * @author KADY
 */
public class RecipeTimeController implements Initializable {
    ...
    void deleteaction(ActionEvent event) throws FileNotFoundException, IOException {
        ...
        Sheet spreadsheet = workbook.createSheet("Kadysoft_Recipe_Time");
        ...
        dialog.setInitialFileName("Kadysoft_Recipe_Time");
...
//      
//         try{
//        String sql ="select * from Audit where Date=? ";
//        
//        pst=conn.prepareStatement(sql);
//        pst.setString(1, positionfield.getText());
//        rs=pst.executeQuery();
//        //////////////////////////////////
//        
//             
